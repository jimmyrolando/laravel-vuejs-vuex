...
exports.default = {
	getCurrentUser: function getCurrentUser(cb) {
		var ecb = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];

		_vue2.default.http.get('profiles').then(function (resp) {
	...
	getAllUsers: function getAllUsers(cb) {
		...
		_vue2.default.http.get('users').then(function (resp) {
			return cb(resp.data.users);
		}, function (resp) {
			return ecb(resp.data);
		});
	},
	uploadAvatar: function uploadAvatar(formData, cb) {
	...
	logout: function logout(cb) {
		_vue2.default.http.get('logout').then(function (resp) {
			return cb(resp.data);
		});
	},
	deleteUser: function deleteUser(user, cb) {
		_vue2.default.http.post('users/' + user.id, { '_method': 'DELETE' }).then(function (resp) {
			return cb(resp.data);
		});
	},
...
},{"vue":4,"vue-resource":3}],8:[function(require,module,exports){
...
var _updateUser = require('./shared/update-user.vue');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-65ca6acd", module.exports)
  } else {
...
var _updateAvatar = require('./shared/update-avatar.vue');

var _updateAvatar2 = _interopRequireDefault(_updateAvatar);

var _updateProfile = require('./shared/update-profile.vue');
...
exports.default = {
    components: {
        UpdateAvatar: _updateAvatar2.default, UpdateProfile: _updateProfile2.default, CreateProfile: _updateProfile2.default
    },
    data: function data() {
        return {
            currentModal: '',
    ...
    methods: {
        geocodeAddress: function geocodeAddress() {
            ...
            var map = this.map;
            var address = this.currentUser.address;
    ...
    events: {
        'google-loaded': function googleLoaded() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f92e9ab2", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1c83de44", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-889a85d2", module.exports)
  } else {
...
var getCurrentUser = exports.getCurrentUser = function getCurrentUser(_ref) {
	var dispatch = _ref.dispatch;

	_api2.default.getCurrentUser(function (user) {
		if (!user) {
...
var getAllUsers = exports.getAllUsers = function getAllUsers(_ref2) {
	var dispatch = _ref2.dispatch;

	_api2.default.getAllUsers(function (users) {
		if (users) {
...
var mutations = {
  ...
  UPDATE_AVATAR: function UPDATE_AVATAR(state, avatar) {
